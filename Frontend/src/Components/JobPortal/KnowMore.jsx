  ...
  return (
    <div className="know-more-container">
      ...
      >
        ...
        <Divider dashed />
        <Title level={4} style={{ color: "#ff5722" }}>
          Job Description
        </Title>
        <Text style={{ fontSize: "16px", lineHeight: "1.7" }}>
          We are seeking a dynamic and highly motivated Software Developer to
          join our team. The role involves working with the latest technologies
          in a fast-paced environment, contributing to cutting-edge projects,
          and collaborating with cross-functional teams.
          <br />
          <br />
          Responsibilities include developing, testing, and deploying scalable
          software solutions, debugging and troubleshooting issues, and staying
          updated with industry trends and technologies. You will have the
          opportunity to work on cloud-based solutions, AI-powered applications,
          and much more.
        </Text>
        <Divider dashed />
        <Title level={4} style={{ color: "#ff5722" }}>
        ...
        <ul style={{ fontSize: "16px", lineHeight: "1.7" }}>
          <li>
            Strong foundation in algorithms, data structures, and OOP concepts.
          </li>
          <li>
            Proficiency in one or more programming languages like Java, Python,
            or C++.
          </li>
          <li>
            Good understanding of web technologies such as React, Node.js, and
            RESTful APIs.
          </li>
          <li>
