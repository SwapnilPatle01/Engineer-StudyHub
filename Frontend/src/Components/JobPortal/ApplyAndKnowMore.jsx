...
import "./ApplyAndKnowMore"
const { Title } = Typography;
const { Option } = Select;

const ApplyAndKnowMore = () => {
  ...
  // Use 'view' from location.state or default to 'apply'
  const view = location.state?.view || 'apply';
    ...
    <div>
      {view === 'apply' ? (
        ...
        <div className='Container'>
          ...
          <p>Here you will find more details...</p>
          <ul>
            <li>
...
export default ApplyAndKnowMore;
